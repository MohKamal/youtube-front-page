<template>
    <nav class="navbar navbar-expand-lg navbar-light bg-white navbar-desktop">
        <div class="row w-100">
            <div class="col-md-3 logo-area p-0 pl-3">
            <button class="btn-menu btn-hamburger" type="button" @click="$emit('hamburger')">
            <span class="yt-icon">
                <svg class="hamburger" viewBox="0 0 80 50" width="24" height="24">
